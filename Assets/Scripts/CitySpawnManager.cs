...
public class CitySpawnManager : MonoBehaviour
{
    ...
    {
        if (previousScene == "Office") moneyMessage.text = "Has vendido el USB a unos Señores Naturalmente Inteligentes. Has ganado 1000Zc que han sido depositados en tu caja fuerte";
    }
